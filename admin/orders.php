...
$query = $dbh->prepare("SELECT * FROM ((orders
                                          INNER JOIN suppliers on orders.idf = suppliers.idf)
                                          INNER JOIN products on orders.idpdct=products.idpdct)");
$query->execute();
                        ...
                        <div class="panel-body">
                            <table id="clicktoedit" class="table table-bordered table-striped">
                                ...
                                foreach($result as $row) {
                                    ...
                                    echo "<td tabindex='1' class='text-center'>" . $row['qcom'] . "</td>";
                                    echo "<td tabindex='1' class='text-center'>" . $row['pricef'] . "</td>";
                                    echo "<td tabindex='1' class='text-center'>" . $row['datepur'] . "</td>";
                                    echo "<td class='text-center'>
													<div class='dropdown'>
														...
														<ul class='dropdown-menu panel-settings'>
															<li>
																<a  href='./updateorder.php?id=" . $idc . "' class='reloadBar'>
																	Update
																</a>
															</li>
															<li role='separator' class='divider'></li>
															<li>
																<a  href='./deleteorder.php?id=" . $idc . "' class='reloadBar'>
																	Delete
																</a>
															</li>
														</ul>
