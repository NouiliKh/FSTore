...
if(isset($_POST['btn-sup'])) {
    ...
    if ($user->newsupp($ids,$namesup,$adress,$tel,$fax)) {
        $user->redirect('./suppliers.php');
    }
}
            ...
            <div class="panel panel-body animated fadeInLeft">
                ...
                <div class="panel-body">
                    <form method="post">
                        ...
                        <button name="btn-sup" type="submit" class="center btn btn-success btn-lg btn-block" onsubmit=""> Submit</button>
                    </form>
                </div>
            </div>
        </div>
