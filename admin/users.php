                ...
                <div class="panel panel-default box">
                    ...
                    <div id="collapse2" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <table id="clicktoedit" class="table table-bordered table-striped">
                                ...
                                <tr class="text-center">
                                    <th class="text-center">Fullename</th>
                                ...
                                foreach($result as $row){
                                    ...
                                    echo	"<tbody>";
                                    echo	"<tr>";
                                    echo	"<td tabindex='1' class='text-center'>".$row['fullName']."</td>";
                                    echo    "<td tabindex='1' class='text-center'>".$row['email']."</td>";
                                    echo    "<td tabindex='1' class='text-center'>".$row['role']."</td>";
                                    echo	"<td class='text-center'>
													<div class='dropdown'>
														...
														<ul class='dropdown-menu panel-settings'>
															<li>
																<a  href='./updateuser.php?id=".$id."' class='reloadBar'>
																	Update
																</a>
															</li>
															<li role='separator' class='divider'></li>
															<li>
																<a  href='./deleteuser.php?id=".$id."' class='reloadBar'>
																	Delete
																</a>
															</li>
														</ul>
                        ...
                        <div class="panel-footer">
                            <a class="btn btn-info add-row" href="newuser.php">
                                <button  type="button" class="btn btn-info add-row" data-sort="true"> Add User  </button>
                            </a>
                        </div>
                    </div>
                </div>
