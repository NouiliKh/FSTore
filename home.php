                ...
                <div  id="mega-slider" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active beactive">
                            <img src="img/banner/slide1.jpg" alt="..." width="2560px" height="1440px">
                            <div class="carousel-caption">
                                <h2>Welcome to FSTore</h2>
                                <p>Here, You can find everything you need</p>
                            </div>
                        </div>
                        <div class="item">
                            <img src="img/banner/slide2.jpg"  alt="..." width="2560px" height="1440px">
                            <div class="carousel-caption">
                                <h2>Welcome To FSTore</h2>
                        ...
                        <div class="item">
                            <img src="img/banner/slide3.jpg" alt="...">
                            <div class="carousel-caption">
                                <h2>Welcome to FSTore</h2>
                                <p>Get High Tech Devices With A Low Price</p>
                            </div>
                        </div>
                    </div>
                    <!-- Controls -->
                ...
                <div  class="parallax-block parallaxBg">
                    <div class="container">
                        <div class="parallax-block-text">
                            <p>We are Here For You. <span class="color-green">Thanks for checking out our Store.</span> <br>  Thank you! </p>
                        </div>
                    </div>
                </div>
            </div>
