...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <section>
                <div class="map-box clearfix">
                    <div id="map_container">
                        <div id="map_super" style="height:400px;"></div>
                    </div>
                </div>
            </section>
            <!-- End Map-->
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="single-contact-option text-center">
                                        ...
                                        <p>Address : 121 King Street, Melbourne </p>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="single-contact-option text-center">
                                       <i class="fa fa-phone"></i>
                                        <h6>Number phone</h6>
                                        <p>Phone 1: 0(123) 567 890</p>
                                        <p>Phone 2: 0(456) 567 890</p>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="single-contact-option text-center">
                                      <i class="fa fa-fax"></i>
                                        <h6>Number phone</h6>
                                        <p>Fax 1: 0(123) 567 890</p>
                                        <p>Fax 2: 0(456) 567 890</p>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="single-contact-option text-center">
                                        ...
                                        <h6>Address email</h6>
                                        <a href="mailto:admin@craftdzine.com">info@craftdzine.com</a>
                                        <a href="mailto:admin@craftdzine.com">Nameyour@craftdzine.com</a>
                                    </div>
                                </div>
                            </div>                            
                        </div>
           ...
           <!-- Start Contact-->
            <section class="main-contain bg-white" id="contact">
                <div class="container">
                        <div class="standard-comments-form clearfix">
                            <form>
                                <div>
                                ...
                                <input class="btn btn-product" value="Submit Message" type="submit">
                            </form>
